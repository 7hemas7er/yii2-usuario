...
* little change of yii2-rbac
* thanks to igor-chepurnoi for write yii2-rbac

Applying rules:

********
  For applying rules only for controller add the following code:
********
use Da\User\Filter\AccessControl;
...
********
For applying rules for module add the following code:
********
use Yii;
use Da\User\Filter\AccessControl;
